var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1edr2d0");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1edr2d0");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		...
    		let timer = setInterval(
    			() => {
    				$$invalidate(2, progress += 100 / totalSeconds);
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands." class="svelte-1og64i1">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
	...
	<a href="https://www.soundboard.com/sb/sound/159369/">Sound Source</a>`;

    			t7 = space();
    			audio_1 = element("audio");
    			attr(h1, "class", "svelte-17lkxg");
    			attr(h3, "class", "svelte-17lkxg");
    			if (audio_1.src !== (audio_1_src_value = "sound.mp3")) attr(audio_1, "src", audio_1_src_value);
    		},
    		m(target, anchor) {
